...
tau = 1;
c = 0;
[w_final, T_tilda, q_final, q_bar, w_tilda_star, w_err, yaw_d, yaw_found1, yaw_found2, pitch_d, pitch_found1, pitch_found2, roll_d, roll_found1, roll_found2] = standard_TLC(t_ode, tau, c);
%%

function [w_final, T_tilda, q_final, q_bar, w_tilda_star, w_err, yaw_d, yaw_found1, yaw_found2, pitch_d, pitch_found1, pitch_found2, roll_d, roll_found1, roll_found2] = standard_TLC(t_ode, tau, c)
