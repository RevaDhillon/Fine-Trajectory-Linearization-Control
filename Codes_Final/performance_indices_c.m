...
t_ode = 0:1:1800;
c_list = linspace(-0.2, 0.2);

Jxf = zeros(size(c_list));
Jxs = zeros(size(c_list));
Juf = zeros(size(c_list));
Jus = zeros(size(c_list));

tau = 1;
Tmax = 0.2;

for j = 1:1:length(c_list)
...
figure(4)
plot(c_list, Jxf, 'LineWidth', 2, 'LineStyle','-', 'Color', 'b', 'DisplayName','Fine TLC')
hold on
plot(c_list, Jxs, 'LineWidth', 2, 'LineStyle','-', 'Color', 'r', 'DisplayName','Traditional TLC')
legend("show")
ax = gca;
ax.FontSize = 16;
%ylim(ax, [0, 0.35])
...
figure(5)
plot(c_list, Juf, 'LineWidth', 2, 'LineStyle','-', 'Color', 'b', 'DisplayName','Fine TLC')
hold on
plot(c_list, Jus, 'LineWidth', 2, 'LineStyle','-', 'Color', 'r', 'DisplayName','Traditional TLC')
legend("show")
ax = gca;
ax.FontSize = 16;
%ylim(ax, [0, 0.35])
